...
public class WorldAnimator {
	...
	public void start(Stage s, GameEngine myGameEngine) {
		...
		// collisionTracker = new CollisionTracker("No",
		// restrictedEntityManager.getEntities());
		// movementTracker = new MovementTracker("Go",
		// restrictedEntityManager.getEntities());
	...
	private void step(double elapsedTime) {
		...
		Collection<RestrictedEntity> updatedEntities = myGameEngine
				.handleUpdates(keysPressed);
	...
	private HashMap<Integer, ImageView> fillMap(
