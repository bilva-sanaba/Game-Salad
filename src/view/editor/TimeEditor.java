...
public class TimeEditor extends ComponentEditor {
	private EditableComponents componentName = EditableComponents.Time;
	private Map<IAction,Integer> inputMap = new HashMap<IAction,Integer>();

		private HBox myBox;
		
		public TimeEditor(UtilityFactory utilf) {
