...
public class Reflection {
	...
	public static Object createInstance(String className)
		...
		try {
			...
			throw new ReflectionException(e, NO_PUBLIC_DEFAULT_CONSTRUCTOR,
					className);
		}
	}
	...
	public static Object createInstance(String name, Object... args)
		...
		try {
			...
			throw new ReflectionException(e, NO_MATCHING_PUBLIC_CONSTRUCTOR,
					name);
		}
	}
	...
	public static Object callMethod(Object target, String name)
		...
		try {
			...
			throw new ReflectionException(e, NO_MATCHING_PUBLIC_METHOD, name,
	...
	public static Object callMethod(Object target, String name, Object... args)
		...
		try {
			...
			throw new ReflectionException(NO_MATCHING_PUBLIC_METHOD, name,
					target.getClass().getName());
		} catch (Exception e) {
			throw new ReflectionException(e, NO_MATCHING_PUBLIC_METHOD, name,
					target.getClass().getName());
	...
	public static Object getFieldValue(Object target, String name)
		...
		try {
			...
			throw new ReflectionException(e,
					NO_MATCHING_PUBLIC_INSTANCE_VARIABLE, target.getClass()
							.getName());
		}
	}
